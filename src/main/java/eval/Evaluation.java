...
public class Evaluation {
	...
	// return short text for result
	@Override
	public String toString() {
		StringBuffer out = new StringBuffer();
		for (Result res : this.results) {
			out.append(res.eval.getName());
			out.append(" ");
			out.append(String.format("%.5f", res.precision));
			out.append(" ");
			out.append(String.format("%.5f", res.recall));
			out.append(" ");
			out.append(String.format("%.5f", res.fMeasure));
		}
		return out.toString();
	}
